...
export const netVote = (units: ITestUnitsMap): ITestCase[] => [
  {
    ...
    caseUnits: [
      ...
      // user 6 vote self
      [units.net.enter(2), 2],
      [units.vote.set.self, 2],
      [units.vote.unSet.self, 2],
      ...
      [units.events.read.vote.forMembers, 5],
      [units.account.login.user(12), 5],
      [units.events.read.vote.forMembers, 5],
      [units.events.read.vote.forVoteMember, 1],
      [units.events.read.vote.forDisvoteMember, 4],
      [units.events.read.vote.forMembersInTree, 7],
      // [units.events.read.vote.forConnectedInTree, 8],
      [units.events.read.vote.forMembersInTree, 8],
      [units.events.read.vote.forMembersInCircle, 3],
      [units.events.read.vote.forFacilitator, 2],
