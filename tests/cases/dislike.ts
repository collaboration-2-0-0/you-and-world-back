...
export const netVote = (units: ITestUnitsMap): ITestCase[] => [
  {
    ...
    caseUnits: [
      ...
      [units.events.read.leave.dislikeInCircle, 5],
      [units.events.read.disconnect.dislike, 2],
      // user 5 connect user 10 // user 5 confirm user 10
      ...
      [units.events.read.connectAndConfirmInCircle, 5],
      [units.events.newEvents, 6],
      [units.events.read.connectAndConfirmInCircle, 6],
      // [units.invite.confirm.tMember(0), 1],
      // [units.events.newEvents, 2],
      // [units.events.read.confirm, 2],
      // user 5 dislike user 6
      ...
      [units.events.read.connectAndConfirmInCircle, 6],
      [units.events.newEvents, 7],
      [units.events.read.connectAndConfirmInCircle, 7],
      ...
      [units.events.read.leave.dislikeFacilitator, 2],
